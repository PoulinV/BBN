													  	...
													  	Structure_Spectrum_and_Precision_Parameters * pt_Spectrum_and_Precision_Parameters){
																...
																cout << "Printing in file " << name <<"."<<  endl;
																	...
																	double PP = 0, CS= 0, ICS_g = 0, ICS_e= 0, NPC= 0, COM= 0, DP= 0;
																			...
																			if(pt_Spectrum_and_Precision_Parameters->inverse_compton_scattering == "yes")Rate_electrons_E_e = integrator_simpson_rate_inverse_compton_v2(z,E_cmb_min,E_cmb_max,E_g,pt_Spectrum_and_Precision_Parameters);
			...
			if(i==(pt_Spectrum_and_Precision_Parameters->Electron_Table_Size-1)){
				...
				for (int j = i+1 ; j < pt_Spectrum_and_Precision_Parameters->Electron_Table_Size; j ++){
					...
					if(Rate_electrons_E_e!=0){
						...
						// ICS_e =  dE_j * pt_Electron_Spectrum->Spectrum[j]  * 2*pi*r_e*r_e*m_e*m_e*integrator_simpson_scattered_electron_inverse_compton(z,E_e,E_j,pt_Spectrum_and_Precision_Parameters)/(E_j*E_j)/Rate_electrons_E_e;
