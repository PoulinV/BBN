        ...
        if(pt_Spectrum->species == "photon") {
            if(pt_Spectrum_and_Precision_Parameters->photon_spectrum_choice == "universal") {
                ...
                if(pt_Spectrum_and_Precision_Parameters->calculation_mode=="iterative") {
                    os << "output/Cascade_Spectrum_Folder/Spectrum_"<<pt_Spectrum->spectrum_name<<"m" << pt_Particle_Physics_Model->M_x<<"_z"<< z <<"_" << pt_Spectrum_and_Precision_Parameters->number_iterations_photon <<"iterations.dat";
                } else if(pt_Spectrum_and_Precision_Parameters->calculation_mode=="triangular") {
                    os << "output/Cascade_Spectrum_Folder/Spectrum_"<<pt_Spectrum->spectrum_name<<"m" << pt_Particle_Physics_Model->M_x<<"_z"<< z <<"_" << "triangular.dat";
                }
            }

        } else if(pt_Spectrum->species == "electron") {
            if(pt_Spectrum_and_Precision_Parameters->calculation_mode=="iterative") {
                os << "output/Cascade_Spectrum_Folder/Spectrum_"<<pt_Spectrum->spectrum_name<<"m" << pt_Particle_Physics_Model->M_x<<"_z"<< z <<"_" << pt_Spectrum_and_Precision_Parameters->number_iterations_electron <<"iterations.dat";
            } else if(pt_Spectrum_and_Precision_Parameters->calculation_mode=="triangular") {
                os << "output/Cascade_Spectrum_Folder/Spectrum_"<<pt_Spectrum->spectrum_name<<"m" << pt_Particle_Physics_Model->M_x<<"_z"<< z <<"_" << "triangular.dat";
            }
        }
...
void fill_structure_particle_physics_model(ifstream &file, map_parameters &map_parameters, Structure_Particle_Physics_Model * pt_Particle_Physics_Model)
{
    ...
    if(file) {
        cout << "(function : fill_structure_particle_physics_model) : Reading input parameters file."<< endl;
    } else {
...
void fill_structure_scan_parameters_and_results(ifstream &file, map_parameters &map_parameters, Structure_Scan_Parameters_and_Results * pt_Scan_Parameters_and_Results)
{
    ...
    string error_name="",error_value="";
    if(file) {
        cout << "(function : fill_structure_scan_parameters) : Reading input parameters file."<< endl;
    } else {
        ...
        Structure_Spectrum_and_Precision_Parameters * pt_Spectrum_and_Precision_Parameters)
{
    ...
    string error_name="",error_value="";
    if(file) {
        cout << "(function : fill_structure_spectrum_and_precision_parameters) : Reading input parameters file."<< endl;
    } else {
...
void fill_structure_output_options(ifstream &file, map_parameters &map_parameters, Structure_Output_Options * pt_Structure_Output_Options)
{
    ...
    string error_name="",error_value="";
    if(file) {
        cout << "(function : fill_output_options) : Reading input parameters file."<< endl;
    } else {
    ...
    pt_Structure_Output_Options->Test_functions_verbose = atoi(map_parameters["Test_functions_verbose"].c_str());
...
void fill_default_parameters(ifstream &file, map_parameters &map_parameters)
{
    ...
    string line;
    if(file) {
        cout << "(function : fill_default_parameters) : Reading default parameters file."<< endl;
    } else {
    ...
    while(file) {
        ...
        if(error_value == "yes" || error_name == "yes") {
            ...
            if(name!="ignore_line" && value!="ignore_line") {
                map_parameters[name]=value;
            }
        }
    }
...
void get_parameter_from_file(ifstream &file, string &parameter)
{
    ...
    string error_name="",error_value="";
    if(file) {
        cout << "(function : get_parameter_from_file) : Attribute " << parameter << " parameter."<< endl;
    } else {
...
void check_value_and_name_error(string &name,string &error_name, string &value,string &error_value)
{
    ...
    } else if(name == "EM_cascade_verbose" || name == "BBN_constraints_verbose" || name == "Test_functions_verbose" || name == "Input_verbose" || name == "Output_verbose") {
            ...
            for(int eval=0; eval < pt_Spectrum_and_Precision_Parameters->eval_max; eval++) {
                if(eval == 0) {
                    if(i==0)	{
                        ...
                        t[eval]=t[pt_Spectrum_and_Precision_Parameters->eval_max-1];
                    }
                } else {
                    t[eval]=t[0]+eval*h;
                }
