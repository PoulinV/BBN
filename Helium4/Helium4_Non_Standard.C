...
int main()
{
  ...
  double B ;
  double z,s_Li,s_De,s_He,A,dY_Li,dY_De,dY_4He,A_theo,Y_0 = 2.63*pow(10,-5);
  double omega_b = 0.02273;
  double tau_n = 880.3, tau_n_0 = 880.3;
  double Y_4He_0 = 0.248*pow(omega_b/0.02273,0.39)*pow(tau_n/tau_n_0,0.72), Y_4He_min = 0.2507; //0.2368
  ...
  ofstream output_De("../Output4He/results_Graphe_He_non_standard_avec_reinj_30MeV_5mai2015.dat");
