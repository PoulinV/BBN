...
int main()
{
	...
	// ofstream output_3He("../Output3He/results_Graphe_3He_spectre_universel.dat");
	ofstream output_3He("../Output3He/results_Graphe_3He_non_standard_30MeV_quatre_iterations_corrected.dat");
	int x =0;
	...
	ifstream file4("../TableIntegraleSpectre/results_une_iteration_Destruc3He_30MeV.dat");
	ifstream file5("../TableIntegraleSpectre/results_deux_iterations_Destruc3He_30MeV.dat");
	ifstream file6("../TableIntegraleSpectre/results_trois_iterations_Destruc3He_30MeV.dat");
	ifstream file7("../TableIntegraleSpectre/results_une_iteration_Produc3He_30MeV.dat");
	ifstream file8("../TableIntegraleSpectre/results_deux_iterations_Produc3He_30MeV.dat");
	ifstream file9("../TableIntegraleSpectre/results_trois_iterations_Produc3He_30MeV.dat");
	ifstream file10("../TableIntegraleSpectre/results_quatre_iterations_Produc3He_30MeV_corrected.dat");
	ifstream file11("../TableIntegraleSpectre/results_quatre_iterations_Destruc3He_30MeV_corrected.dat");
	...
	fill_table_from_file(file0,vector_z_s4He_destruc_standard,vector_s4He_destruc_standard);
		...
		//
			...
			// for(int i=0;i<vector_z_s3He_destruc.size();i++)cout << vector_z_s3He_destruc[i]<< " "<< vector_s3He_destruc[i] << endl;
			...
			fill_table_from_file(file6,vector_z_s3He_destruc_trois_iterations,vector_s3He_destruc_trois_iterations);
				...
				fill_table_from_file(file10,vector_z_s3He_produc_quatre_iterations,vector_s3He_produc_quatre_iterations);
				fill_table_from_file(file11,vector_z_s3He_destruc_quatre_iterations,vector_s3He_destruc_quatre_iterations);
				fill_table_from_file(file12,vector_z_s4He_destruc_quatre_iterations,vector_s4He_destruc_quatre_iterations);
				for(int i=0;i<vector_z_s3He_destruc_quatre_iterations.size();i++)cout << vector_z_s3He_destruc_quatre_iterations[i]<< " "<< vector_s3He_destruc_quatre_iterations[i] << endl;
	...
	double Delta = (tau_moy-pow(10,4))/(h_moy);
	...
	for(int h=0;h<h_max;h++)
	{
		...
		for(int l=12;l>1;l--)
		{
			for(double k=1;k<10;k+=0.1)
			{
				...
				// A = qsimp(K_Perte_3He_sans_reinj,z_max,z,z,15,E_0,Z_x,z);
				// B = qsimp(S_Gain_3He_sans_reinj,z_max,z,z,15,E_0,Z_x,z);
				// cout << " A = "<< A << " B = " << B << endl;
			//~
