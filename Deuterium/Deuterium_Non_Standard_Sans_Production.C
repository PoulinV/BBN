...
int main()
{
    ...
    ofstream output_De("OutputDe/results_Graphe_De_standard_sans_production_4Mai2015.dat");
    // ofstream output_De("OutputDe/results_Graphe_De_non_standard_20MeV_quatre_iterations_4Mai2015.dat");
    ifstream file("../TableIntegraleSpectre/results_Reinj_Monochromatique_Destruc2H_20MeV.dat");
    ifstream file2("../TableIntegraleSpectre/results_deux_interactions_Destruc2H_20MeV.dat");
    ifstream file3("../TableIntegraleSpectre/results_trois_iterations_Destruc2H_20MeV.dat");
    ifstream file4("../TableIntegraleSpectre/results_quatre_iterations_Destruc2H_20MeV_corrected.dat");
    ...
    fill_table_from_file(file3,vector_z_s2H_destruc_trois_iterations,vector_s2H_destruc_trois_iterations);
    fill_table_from_file(file4,vector_z_s2H_destruc_quatre_iterations,vector_s2H_destruc_quatre_iterations);
